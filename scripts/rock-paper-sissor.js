...
autoPlayBtn = document.querySelector('.js-autoplay')
...
const autoplayGame = autoPlayBtn.addEventListener('click', () => playingGame());
...
document.querySelector('.js-Reset').addEventListener('click', () => resetScoreMessage());
...
function resetScoreMessage(){
    document.querySelector('.deleteConfirmation')
